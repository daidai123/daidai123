...
if($actiontype=="mod") {
  ...
  $postid=$_POST["pid"];
  $nextactionpage="demondpreview.php";
} else{
  $postdate=date("Y-m-d H:i:s");
  $nextactionpage="securimag/securitydemoncheck.php";
}
$online_offline = "<span style=\"font-size:18; font-weight:bold; color: green;\">".ONLINE."</span>";


$_SESSION["demond_add_email"]=$email;
$_SESSION["demond_add_title"]=$title;
$_SESSION["demond_add_country"]=$country;
$_SESSION["demond_add_state"]=$state;
$_SESSION["demond_add_city"]=$city;
$_SESSION["demond_add_catergory"]=$catergory;
$_SESSION["demond_add_contactpub"]=$contactpub;
$_SESSION["demond_add_emailshow"]=$emailshow;
$_SESSION["demond_add_postdescription"]=$postdescription;
...
if($_POST["confirm"]!=""){
		...
		header("Location: postsu.php?pt=1&op=m&pid=".$postid);
	    die();	
}
...
<div class="fb_content clearfix" id="content">
  ...
  <div style=" float:left; width:20%; min-width:240px; margin-top:25px;">
   ...
   <table cellpadding="4" cellspacing="4" style="width:100%;">
	 ...
	 <?php if($_SESSION["interbringeruserId"]>0){?>
	   <a href="javascript:void(0)" style="font-size:18px; color:#0C36E0; font-weight:bold;" onClick="javascript:chatWith('<?php echo get_user_name($userid, $db);?>')"><img src="<?php echo LANGUAGE_SELECT_FOLDER_CHOOSE; ?>/geiwoliuyan.png"  /></a>
  ...
  <div id="content" class="fb_content clearfix" style=" float:right; min-height:400px;width:78%;">
