 ...
 if ($_POST["check_supply_post"]=="Submit") {
  ...
  if($valid == true) {
       ...
       /* //open the database
        ...
        $sql .= "(null,'$title','$catergory', $user_id, $country, $state, $city, $countryback, $stateback, $cityback, '$price', '$backdate', '$contactpub', '$email', $emailshow, '".$postdescription."','$postdate', 1, ".$iplocation_c.",'".$ip."', ".$locationinfo["longitude"].", ".$locationinfo["latitude"].", 0, 'N')";
	    ...
	    header("Location: ../postsu.php?pt=1&t=s&op=pb&pid=".$fID);
	    die(); 
  } else {
		...
		<tr>
            ...
            <tr>
              <td style="width:100%;"> 
				...
				<form method="post" action="securitysupplycheck-ch.php" enctype="multipart/form-data">
