...
$price=$_POST["price"];
 ...
 if ($_POST["check_supply_post"]=="Submit") {
  ...
  if($valid == true) {		  
        ...
        $sql = "INSERT INTO `supplypost` (`id`,`title`,`catergory`,`userid`, `countryid`, `stateid`, `cityid`,`countryback`, `stateback`, `cityback`, `price`, `backtime`,`pubic`, `replytoemail`, `showemailtype`, `description`, `postdate`, `post_type`,`postlocation`, `ip`, `longtitude`, `latitude`,`view`, `email_check`)  VALUES ";
        $sql .= "(null,'$title','$catergory', $user_id, $country, $state, $city, $countryback, $stateback, $cityback, '$price', '$backdate', '$contactpub', '$email', $emailshow, '".$postdescription."', '$postdate', 2,".$iplocation_c.", '".$ip."', ".$locationinfo["longitude"].", ".$locationinfo["latitude"].",0, 'N')";
	    ...
	    header("Location: ../postsu.php?pt=2&t=s&op=pb&pid=".$fID);
	    die(); 
  } else {
...
<title><?php echo SECURITY_CODE_CHECK; ?>|InterBringer</title>
...
<!-- end #header -->
	...
	<?php } ?>
      <tr>
        <td><table cellpadding="8" cellspacing="8" border="0" width="40%">
		<tr>
            ...
            <tr>
              <td style="width:100%;"> 
				...
				<form method="post" action="securitysupplycheck-cht.php" enctype="multipart/form-data">
                <table cellpadding="4" cellspacing="4">
				  <tr>
				  <td>
				  <div style="width: 100%; float: left; height: 90px"> <img id="siimage" align="left" style="padding-right: 5px; border: 0" src="securimage_show.php?sid=<?php echo md5(time()) ?>" />
                  ...
                  <!--check($_POST['code']) will check the submitted form field -->
				     <input type="text"  name="code" value="" style="width:200px;" class="inputtext" />
                  ...
                  <input type="submit" style="width:100px;"  value="<?php echo SUBMIT; ?>" />	
				  </td>
				</tr>
				</table>
                </form>
