...
<div style="width:600px;margin:0 auto;padding-top:50px;">
	<div>
		<h3 style="font-size:16px;padding:5px;border-bottom:solid 1px #ccc;"><?php echo UPLOAD_PIC_POWER_BY; ?></h3>
		<div style="padding:10px 0;color:#666;">
		Please Upload Picture or <a style="color:#cc3300;" href="javascript:void(0);" onclick="useCamera()">Please Use Camera</a>
		</div>
