...
if($actiontype=="mod") {
  ...
  $postid=$_POST["pid"];
  $nextactionpage="supplypostpreview.php";
} else{
  $postdate=date("Y-m-d H:i:s");
  $nextactionpage="securimag/securitysupplycheck-ch.php";
}


$_SESSION["supply_add_email"]=$email;
$_SESSION["supply_add_title"]=$title;
$_SESSION["supply_add_country"]=$countryid;
$_SESSION["supply_add_state"]=$stateid;
$_SESSION["supply_add_city"]=$cityid;
$_SESSION["supply_add_countryback"]=$countryback;
$_SESSION["supply_add_stateback"]=$stateback;
$_SESSION["supply_add_cityback"]=$cityback;
$_SESSION["supply_add_catergory"]=$catergory;
$_SESSION["supply_add_contactpub"]=$contactpub;
$_SESSION["supply_add_emailshow"]=$emailshow;
$_SESSION["supply_add_postdescription"]=$postdescription;
$_SESSION["supply_add_backdate"]=$backdate;
...
if($_POST["confirm"]!=""){
		...
		header("Location: postsu.php?pt=1&t=s&op=m&pid=".$postid);
	    die();	
}
