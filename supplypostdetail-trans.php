...
include("inc/function.php");
      ...
      {	  
	    ...
	    header("Location: postsu.php?pt=2&t=s&op=d&pid=".$postid."");	
	    die();	   
	    ...
	    header("Location: postsu.php?pt=2&t=s&op=rp&pid=".$postid."");	
	    die();	   
    }
