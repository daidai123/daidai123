	      ...
	      <form name="postsupplyform" id="postsupplyform" enctype="multipart/form-data" action="supplypostpreview.php" method="post">               
               ...
               <tr>
                <td style="width:100%;" colspan="6" nowrap="nowrap">
			     <input type="text" class="inputtext" id="title" style="width:98%; font-size:18px;" name="title" value="<?php echo $_SESSION["supply_add_title"];?>" /><span style="color:#FF0000;">*</span>
                </td>
                 </tr>
		   ...
		   <tr>
			  <td colspan="6" nowrap="nowrap" style="font-family:'Times New Roman', Times, serif; font-size:15px;">
			     <?php echo BACK_HOME_TIME; ?>: <input type="text" class="inputtext" id="backdate" name="backdate" onClick="fPopCalendar('backdate')"  readonly="readonly" value="<?php echo $_SESSION["supply_add_backdate"]; ?>" />
              </td> 
		   </tr>
			...
			?>
			 ...
			 <?php }
			  ...
			  <?php  } ?>
				...
				<tr>
				<?php if($_SESSION["supply_add_contactpub"]=="Y"){
			 ...
			 <tr>
			 <?php if($_SESSION["supply_add_emailshow"]=="2"){
              ...
              <td colspan="6" style="font-family:'Times New Roman', Times, serif; font-size:15px;" nowrap="nowrap">
				 ...
				 <input type="radio" id="emailshow" value="1" <?php echo $emailshow_yes;?> name="emailshow" /><?php echo SHOW; ?>&nbsp;<input type="radio" value="2" id="emailshow" name="emailshow" <?php echo $emailshow_no;?> /> <?php echo HIDE; ?>
                  ...
                  $oFCKeditor->Value = $_SESSION["supply_add_postdescription"];
                  $oFCKeditor->Create() ;
                   ?>
                      </div>
					  </td>
