		 ...
		 <form name="postdemondform" id="postdemondform" enctype="multipart/form-data" action="demondpreview-t.php" method="post">               
               ...
               <tr>
                <td style="width:100%;" colspan="6" nowrap="nowrap">
			     <input type="text" class="inputtext" id="title" style="width:98%; font-size:18px;" maxlength="65" name="title" value="<?php echo $_SESSION["trans_demond_add_title"];?>" /><span style="color:#FF0000;">*</span>
                </td>
               </tr>
			   <tr><td colspan="6"><div id="title_check"></div></td></tr>
     
			   <tr><td colspan="6" style="font-family:'Times New Roman', Times, serif; font-size:15px;">
			 ...
			 <td id="city_border" style="width:25%;" nowrap="nowrap">
			  ...
			  ?>
			   <tr>
			    ...
			    <?php echo NEED_TAKE_TO_LOCATION; ?>: 
			    <?php echo COUNTRY; ?>: 
			    </td>
			...
			<?php if($_SESSION["trans_demond_add_countryback"]!=""){ ?>
			 ...
			 <?php }
			  ...
			  <?php  } ?>
				...
				<?php if($_SESSION["trans_demond_add_contactpub"]=="Y"){
			...
			<tr>
			 ...
			 <?php if($_SESSION["trans_demond_add_emailshow"]=="2"){
              ...
              <td style="font-family:'Times New Roman', Times, serif; font-size:15px;" colspan="6" nowrap="nowrap">
                ...
                <tr>
                 ...
                 $oFCKeditor->Value = $_SESSION["trans_demond_add_postdescription"];
                 $oFCKeditor->Create() ;
                  ?>
				  </div>
                  </td>
				   ...
				   <tr><td style="padding-top:2px;text-align:right;" colspan="6" >
