   ...
   <div class=signup_bar_container style="height:50px;">
	...
	<table style="width:90%;" border="0">
	 <tr>
	  ...
	  <td>
	  <select id="type" name="type" style="width:150px; height:28px; color:#999999; font-size:18px;">
	  <option value="bringer">寻找代购者</option>
	  <option value="needer">寻找求运者</option>
	  <option value="transbringer">寻找代运者</option>
	  <option value="transneeder">寻找求运者</option>
	  </select> 
	  </td>
	   <td>
