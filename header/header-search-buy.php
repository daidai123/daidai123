...
<body>
<div class="loggedout_menubar_container" style="background:#FB952F;">
              ...
              <tbody>
                ...
                <tr>
                  <td class="login_form_label_field"><input class="inputcheckbox" value="1" id="persistent" name="persistent" tabindex="3" type="checkbox">
                    <label id="label_persistent" for="persistent" style="color:#000000;"><?php echo KEEP_ME_LOGIN; ?></label></td>
                  <td class="login_form_label_field"><a href="forgetpassword.php" style="color:#000000;" rel="nofollow"><?php echo FORGETPASSWORD; ?>?</a></td>
                </tr>
              </tbody>
            </table>
          </form>
