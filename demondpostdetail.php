...
include("inc/function.php");
      ...
      {	  
	    ...
	    header("Location: postsu.php?pt=1&op=d&pid=".$postid."");	
	    die();	   
	    ...
	    header("Location: postsu.php?pt=1&op=rp&pid=".$postid."");	
	    die();	   
    }
   ...
   $contactinf_link="#";
	...
	if($online_offline){
	  $online_offline_m="<img src=\"". LANGUAGE_SELECT_FOLDER_CHOOSE."/online.png\" width=\"25\" height=\"25\"  alt=\"用户在线\" />";
	  $online_offline_search_m="<img src=\"". LANGUAGE_SELECT_FOLDER_CHOOSE."/yuwolianxi.png\" alt=\"与我联系\" />";// this will show that your user is currently offline
	  $trans_to_the_href="href=\"javascript:void(0)\" onClick=\"javascript:chatWith('".get_user_name($userid, $db)."')\"";
    }else{
	  $online_offline_m="<img src=\"". LANGUAGE_SELECT_FOLDER_CHOOSE."/offline.png\" width=\"25\" height=\"25\"  alt=\"用户离线\" />";
	  $online_offline_search_m="<img src=\"". LANGUAGE_SELECT_FOLDER_CHOOSE."/geiwoliuyanh.png\"  alt=\"给我留言\" />";// this will show that your user is currently online
