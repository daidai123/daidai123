...
?>
 ...
 ?>
  ...
  <div id="content" class="fb_content clearfix" style="min-height:500px; width:100%;">
	...
	<img src="<?php echo LANGUAGE_SELECT_FOLDER_CHOOSE; ?>/step-3.png" style="width:100%;" />
	</div>
	      ...
	      <form name="postdemondform" id="postdemondform" enctype="multipart/form-data" action="demondpreview.php" method="post">               
		   ...
		   <?php
			...
			?>
			 ...
			 <tr>
			 <?php if($_SESSION["demond_add_contactpub"]=="Y"){
			  ...
			  <td  colspan="6" nowrap="nowrap" style="font-family:'Times New Roman', Times, serif; font-size:15px;">
			     <span style="color:#0000FF;"><?php echo PUBLICYOURPROFILEQU; ?></span>  <?php echo YES; ?><input type="radio" value="Y" id="contactpub" name="contactpub" <?php echo $contactpub_yes; ?>  />&nbsp; <?php echo NO; ?><input type="radio" id="contactpub" value="N" name="contactpub"  <?php echo $contactpub_no; ?> /><span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;"><?php echo PUBLICINFORINSTRUCTIONDEMAND; ?></span>
              </td> 
            </tr>
			 <tr>
			 <?php if($_SESSION["demond_add_emailshow"]=="2"){
