...
<title><?php echo FINDNEEDER; ?> |Interbringer</title>
...
<?php
	...
	$_SESSION["pagesizforbuyer"]=$_POST["pagesiz"]; 
     ...
     $checkquery=mysql_query("SELECT * FROM `demandpost` WHERE post_type = 1 $searchforQuery $countrySearch $stateSearch $citySearch $catergorySearch $searchdateQuery", $db);
	 ...
	 if($totalrecord)
      {
		...
		$pageQury=" LIMIT ". $startrecordindex.",".$_SESSION["pagesizforbuyer"];
              ...
              $sql="SELECT * FROM `demandpost` WHERE post_type = 1 $searchforQuery $countrySearch $stateSearch $citySearch $catergorySearch $searchdateQuery ORDER BY `postdate` DESC $pageQury";
  ...
  <form id="findbuyer_form" method="get" name="findbuyer_form" action="findneeder.php" enctype="multipart/form-data">
   <table cellpadding="4" cellspacing="1" style="width:218px;">
	 ...
	 <tr>
	 <td colspan="2" style="font-weight:bold;" nowrap="nowrap"><?php echo BUYER_LOCATION; ?></td>
	 <!--<td></td>-->
     </tr>
	 <tr>
	 ...
	 <tr>
	 <td colspan="2" >
	 <select id="country" name="country" style="width:200px" onChange="changepro('state','country');" >
	 ...
	 <tr>
	 <td colspan="2">
	  <select id="state" name="state" style="width:200px" onChange="changecity('city','state');">
       <option value=""><?php echo ANY_OF_THEM; ?></option>
	    <?php 
			if($country!="") {
	 ...
	 <tr>
	 <td colspan="2" nowrap="nowrap" style="font-weight:bold;"><?php echo POST_TIME; ?>:
	 </td>
     </tr>
	 <tr>                   
	 <td colspan="2" nowrap="nowrap" style="font-weight:bold;"><?php echo FROM; ?>:
	 </td>
	 </tr>
	 <tr>
	 <td colspan="2">
	 <input type="text" onclick="fPopCalendar('pt1')" readonly="readonly" value="<?php echo $posttime1;?>" name="pt1" id="pt1"  style="width:200px;"/>
     </td>                  
	 </tr>
	 <tr>
	 ...
	 <tr>
	 <td colspan="2">
	 <input type="text" onclick="fPopCalendar('pt2')" readonly="readonly" value="<?php echo $posttime2;?>" name="pt2" id="pt2"  style="width:200px;"/>
     </td>
	</tr>
	<tr>
	<td colspan="2" style="height:20px;">
	...
	<td  style="text-align:right; width:50%;">
	  ...
	  [<a href="findneeder.php" style="color:#000000;font-size:15px; font-weight:bold;" ><?php echo START_OVER;?></a>]
	  </td>
	</tr>
   </table>
   </form>
  ...
  <div id="content" class="fb_content clearfix" style="min-height:500px; min-width:650px; width:73.5%; margin-left: 230px;">
	...
	<div id="mainContainer" style="width:85%; float:left;"  >
       <div style="margin-top:30px; margin-left:20px; padding-bottom:5px; width:100%;font-size:20px; border-bottom:#AAAAAA solid 1px; font-weight:bolder;">
	     <?php echo BUYER_RESULT_FINDBRINGER; ?>
	   </div>
		 ...
		 <div style="width:100%; margin-top:20px;">
		   <table cellpadding="0" cellspacing="0" border="0" style="width:100%; border-bottom:#CCCCCC solid 1px;">
                  <tr>
					...
					<?php echo (($pageindex*$_SESSION["pagesizforbuyer"])-9); ?>-<?php 
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td  style="width:90%;"colspan="4"><a href="demondpostdetail.php?pid=<?php echo $row["id"];?>" class="title"><?php echo $row["title"]; ?></a>
					 </td>
					  <td>
					  <table>
					   <tr>
					     <td align="center" nowrap="nowrap"><a href="demondpostdetail.php?pid=<?php echo $row["id"];?>" style="color:#0000FF;"><?php echo CHECK; ?></a></td>
				...
				<form name='formpage2' method=post action='<?php echo "findneeder.php?&t=".$title."&ts=".$title_search."&country=".$country."&state=".$state."&city=".$city."&pt1=".$posttime1."&pt2=".$posttime2."&ca=".$catergory."&nt=".$needtime; ?>' >
                  <tr>
				  ...
				  <form name='formpage' method=post action='<?php echo "findneeder.php?&t=".$title."&ts=".$title_search."&country=".$country."&state=".$state."&city=".$city."&pt1=".$posttime1."&pt2=".$posttime2."&ca=".$catergory."&nt=".$needtime; ?>' >
                  <tr>
	...
	<div style="width:50px; float:right; margin-right:20px;">
	 <?php include("informationbord.php"); ?>
    </div>
