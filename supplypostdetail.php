...
include("inc/function.php");
      ...
      {	  
	    ...
	    header("Location: postsu.php?pt=1&t=s&op=d&pid=".$postid."");	
	    die();	   
	    ...
	    header("Location: postsu.php?pt=1&t=s&op=rp&pid=".$postid."");	
	    die();	   
    }
	  ...
	  if($showemailtype==1){
	   ...
	   if($_SESSION["language_be_choosed"]=="eng"){
		  $title_detail_show=translateToenglish($title_detail);
		  $description_show=translateToenglish($description);
	     }else{
		  $title_detail_show=translateTochinese($title_detail);
...
<div class="fb_content clearfix" id="content">
  ...
  <div style=" float:left; width:19%; margin-top:15px;">
  
  <div style="border:#D8DFEA solid 1px; width:243px;">
   <table cellpadding="4" cellspacing="4" style="width:100%;">
	 ...
	 <tr>
	 <td style="" colspan="1" nowrap="nowrap">
  ...
  <div id="content" class="fb_content clearfix" style=" float:right; min-height:500px;width:80%;">
	...
	<div id="mainContainer" style="width:90%;"  >
       <div style="margin-top:15px; margin-left:20px; padding-bottom:5px; width:100%;">
	     <div style="font-size:20px;font-weight:bolder;"><?php echo $title_detail_show; ?></div>
	   ...
	   <?php if($current_user==$userid){?>
	    ...
	    <?php }  ?> 
		 ...
		 <div style="width:100%; margin-top:20px; font-size:13px;">
		   <?php echo stripslashes($description_show); ?>	       
		 </div>
	   </div>
    </div>
  </div>
